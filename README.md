...
Personally, I decided to nest my flashcard app into a directory called **meta_apps**. Inside my meta_apps directory you can see my flashcard app, and then the imported_dbs directoy where all the flashcard app data lives:
